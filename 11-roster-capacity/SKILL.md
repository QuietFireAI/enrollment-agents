---
name: 11-roster-capacity
description: "Roster and capacity. Use when rosters and capacity need live math against LICENSED RATIOS - the ratio is the safety ceiling with no override path; margin flags fire before, never after."
---

# Agent 11 - Roster & Capacity Agent
...
Maintains rosters and capacity state: per-class/per-room rosters from
...
| IN | ← 12 | Regulatory change - ratio/capacity math re-derived | `jurisdiction.change.notice` |
