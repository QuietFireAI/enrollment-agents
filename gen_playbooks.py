#!/usr/bin/env python3
"""Generate playbooks P01-P14 for the DispatcherAgents Enrollment Swarm (Schools & Childcare)."""
import os
...
def build(p):
    ...
    s += "**Swarm:** DispatcherAgents Enrollment Swarm (Schools & Childcare)\n**Type:** Deployment playbook (consumed by Agent 00 - Dispatcher)\n**Version:** 0.2 (ratified 2026-07-18; extended & ratified 2026-07-18 - owner sign-off)\n\n"
    s += "## Trigger\n" + p["trigger"] + "\n\n## Preconditions\n"
...
from enrollment_playbooks import PB  # single source (fork-drift fix 2026-07-18)
def main():
