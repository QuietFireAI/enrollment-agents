---
name: 02-admissions-pipeline
description: "Admissions pipeline. Use when applications need IDENTICAL-format package assembly, pipeline tracking, and enrollment handoff - admission decisions and their communication are the human's."
---

# Agent 02 - Admissions Pipeline Agent
...
Runs the admissions pipeline: application package assembly (application
...
{
  "envelope_id": "uuid",
  "from_agent": "02-admissions-pipeline",
