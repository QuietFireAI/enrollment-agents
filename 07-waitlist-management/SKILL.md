---
name: 07-waitlist-management
description: "Waitlist management. Use when waitlists need rule-ordered entries and seat offers per the ratified priority rules - off-rule placements are integrity violations."
---

# Agent 07 - Waitlist Management Agent
...
Runs the waitlist per the ratified priority rules (sibling priority,
...
{
  "envelope_id": "uuid",
  "from_agent": "07-waitlist-management",
